...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj13767 = {};return obj13767;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__11103__auto__ = this$;if(and__11103__auto__)
...
{var x__11742__auto__ = (((this$ == null))?null:this$);return (function (){var or__11115__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__11742__auto__)]);if(or__11115__auto__)
{return or__11115__auto__;
} else
{var or__11115__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__11115__auto____$1)
...
return (function (p__13768){var vec__13769 = p__13768;var k = cljs.core.nth.call(null,vec__13769,(0),null);var v = cljs.core.nth.call(null,vec__13769,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__13770){var vec__13771 = p__13770;var k = cljs.core.nth.call(null,vec__13771,(0),null);var v = cljs.core.nth.call(null,vec__13771,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
