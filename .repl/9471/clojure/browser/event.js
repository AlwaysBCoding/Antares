...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj13807 = {};return obj13807;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__11008__auto__ = this$;if(and__11008__auto__)
...
{var x__11647__auto__ = (((this$ == null))?null:this$);return (function (){var or__11020__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__11647__auto__)]);if(or__11020__auto__)
{return or__11020__auto__;
} else
{var or__11020__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__11020__auto____$1)
...
return (function (p__13808){var vec__13809 = p__13808;var k = cljs.core.nth.call(null,vec__13809,(0),null);var v = cljs.core.nth.call(null,vec__13809,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__13810){var vec__13811 = p__13810;var k = cljs.core.nth.call(null,vec__13811,(0),null);var v = cljs.core.nth.call(null,vec__13811,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
