...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15487 = (0);while(true){
var m_15488 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15488 == null))
{} else
{m_15488.call(null);
if((count_15487 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15489 = (count_15487 + (1));
count_15487 = G__15489;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7268__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7268__auto__)
