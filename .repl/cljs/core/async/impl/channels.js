...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t15493 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t15493 = (function (val,box,meta15494){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t15493.cljs$lang$type = true;
cljs.core.async.impl.channels.t15493.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t15493";
cljs.core.async.impl.channels.t15493.cljs$lang$ctorPrWriter = (function (this__7847__auto__,writer__7848__auto__,opt__7849__auto__){return cljs.core._write.call(null,writer__7848__auto__,"cljs.core.async.impl.channels/t15493");
});
cljs.core.async.impl.channels.t15493.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t15493.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15495){var self__ = this;
var _15495__$1 = this;return self__.meta15494;
});
cljs.core.async.impl.channels.t15493.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15495,meta15494__$1){var self__ = this;
var _15495__$1 = this;return (new cljs.core.async.impl.channels.t15493(self__.val,self__.box,meta15494__$1));
});
cljs.core.async.impl.channels.__GT_t15493 = (function __GT_t15493(val__$1,box__$1,meta15494){return (new cljs.core.async.impl.channels.t15493(val__$1,box__$1,meta15494));
});
}
return (new cljs.core.async.impl.channels.t15493(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__7850__auto__,writer__7851__auto__,opts__7852__auto__){return cljs.core._write.call(null,writer__7851__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__7847__auto__,writer__7848__auto__,opt__7849__auto__){return cljs.core._write.call(null,writer__7848__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_15496 = self__.takes.pop();if((taker_15496 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_15496))
{var take_cb_15497 = cljs.core.async.impl.protocols.commit.call(null,taker_15496);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_15497,taker_15496,this$__$1){
return (function (){return take_cb_15497.call(null,null);
});})(take_cb_15497,taker_15496,this$__$1))
);
} else
{}
{
...
var putter_15498 = self__.puts.pop();if(!((putter_15498 == null)))
{var put_handler_15499 = putter_15498.handler;var val_15500 = putter_15498.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_15499))
{var put_cb_15501 = cljs.core.async.impl.protocols.commit.call(null,put_handler_15499);var __15502__$1 = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_15501,__15502__$1,put_handler_15499,val_15500,putter_15498,_,retval,this$__$1){
return (function (){return put_cb_15501.call(null,true);
});})(put_cb_15501,__15502__$1,put_handler_15499,val_15500,putter_15498,_,retval,this$__$1))
);
cljs.core.async.impl.protocols.add_BANG_.call(null,self__.buf,val_15500);
} else
{{
continue;
}
