...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj13886 = {};return obj13886;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__11087__auto__ = this$;if(and__11087__auto__)
...
{var x__11726__auto__ = (((this$ == null))?null:this$);return (function (){var or__11099__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__11726__auto__)]);if(or__11099__auto__)
{return or__11099__auto__;
} else
{var or__11099__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__11099__auto____$1)
...
return (function (p__13887){var vec__13888 = p__13887;var k = cljs.core.nth.call(null,vec__13888,(0),null);var v = cljs.core.nth.call(null,vec__13888,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__13889){var vec__13890 = p__13889;var k = cljs.core.nth.call(null,vec__13890,(0),null);var v = cljs.core.nth.call(null,vec__13890,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
