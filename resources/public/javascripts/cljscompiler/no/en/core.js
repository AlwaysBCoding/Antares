...
var url_encode__delegate = function (s,p__12548){var vec__12550 = p__12548;var encoding = cljs.core.nth.call(null,vec__12550,(0),null);if(cljs.core.truth_(s))
...
var p__12548 = null;if (arguments.length > 1) {
  p__12548 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return url_encode__delegate.call(this,s,p__12548);};
url_encode.cljs$lang$maxFixedArity = 1;
url_encode.cljs$lang$applyTo = (function (arglist__12551){
var s = cljs.core.first(arglist__12551);
var p__12548 = cljs.core.rest(arglist__12551);
return url_encode__delegate(s,p__12548);
});
...
var url_decode__delegate = function (s,p__12552){var vec__12554 = p__12552;var encoding = cljs.core.nth.call(null,vec__12554,(0),null);if(cljs.core.truth_(s))
...
var p__12552 = null;if (arguments.length > 1) {
  p__12552 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return url_decode__delegate.call(this,s,p__12552);};
url_decode.cljs$lang$maxFixedArity = 1;
url_decode.cljs$lang$applyTo = (function (arglist__12555){
var s = cljs.core.first(arglist__12555);
var p__12552 = cljs.core.rest(arglist__12555);
return url_decode__delegate(s,p__12552);
});
...
{var G__12558 = clojure.string.upper_case.call(null,unit);switch (G__12558) {
default:
var G__12559 = unit;switch (G__12559) {
case "M":
...
*/
no.en.core.parse_integer = (function parse_integer(s){return no.en.core.parse_number.call(null,s,(function (p1__12562_SHARP_){return parseInt(p1__12562_SHARP_);
}));
});
/**
* Parse `s` as a long number.
*/
no.en.core.parse_long = (function parse_long(s){return no.en.core.parse_number.call(null,s,(function (p1__12563_SHARP_){return parseInt(p1__12563_SHARP_);
}));
});
/**
* Parse `s` as a double number.
*/
no.en.core.parse_double = (function parse_double(s){return no.en.core.parse_number.call(null,s,(function (p1__12564_SHARP_){return parseFloat(p1__12564_SHARP_);
}));
});
/**
* Parse `s` as a float number.
*/
no.en.core.parse_float = (function parse_float(s){return no.en.core.parse_number.call(null,s,(function (p1__12565_SHARP_){return parseFloat(p1__12565_SHARP_);
}));
});
/**
* Format the map `m` into a query parameter string.
*/
no.en.core.format_query_params = (function format_query_params(m){var params = clojure.string.join.call(null,"&",cljs.core.map.call(null,(function (p1__12568_SHARP_){return clojure.string.join.call(null,"=",p1__12568_SHARP_);
}),cljs.core.map.call(null,(function (p1__12567_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[no.en.core.url_encode.call(null,cljs.core.name.call(null,cljs.core.first.call(null,p1__12567_SHARP_))),no.en.core.url_encode.call(null,cljs.core.second.call(null,p1__12567_SHARP_))],null));
}),cljs.core.remove.call(null,(function (p1__12566_SHARP_){return clojure.string.blank_QMARK_.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second.call(null,p1__12566_SHARP_))));
...
{var query_params = new cljs.core.Keyword(null,"query-params","query-params",900640534).cljs$core$IFn$_invoke$arity$1(m);return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(new cljs.core.Keyword(null,"scheme","scheme",90199613).cljs$core$IFn$_invoke$arity$1(m))?(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,new cljs.core.Keyword(null,"scheme","scheme",90199613).cljs$core$IFn$_invoke$arity$1(m)))+"://"):null))+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var map__12570 = m;var map__12570__$1 = ((cljs.core.seq_QMARK_.call(null,map__12570))?cljs.core.apply.call(null,cljs.core.hash_map,map__12570):map__12570);var password = cljs.core.get.call(null,map__12570__$1,new cljs.core.Keyword(null,"password","password",417022471));var user = cljs.core.get.call(null,map__12570__$1,new cljs.core.Keyword(null,"user","user",1532431356));if(cljs.core.truth_(user))
...
{return cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.mapcat.call(null,(function (p1__12573_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.keyword.call(null,no.en.core.url_decode.call(null,cljs.core.first.call(null,p1__12573_SHARP_))),no.en.core.url_decode.call(null,cljs.core.second.call(null,p1__12573_SHARP_))],null));
}),cljs.core.filter.call(null,(function (p1__12572_SHARP_){return cljs.core._EQ_.call(null,(2),cljs.core.count.call(null,p1__12572_SHARP_));
}),cljs.core.map.call(null,(function (p1__12571_SHARP_){return clojure.string.split.call(null,p1__12571_SHARP_,/=/);
...
}catch (e12575){if((e12575 instanceof Error))
{var e = e12575;if((n__$1 === (0)))
{throw e;
} else
{return null;
}
