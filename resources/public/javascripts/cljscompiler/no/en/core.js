...
var url_encode__delegate = function (s,p__15079){var vec__15081 = p__15079;var encoding = cljs.core.nth.call(null,vec__15081,(0),null);if(cljs.core.truth_(s))
...
var p__15079 = null;if (arguments.length > 1) {
  p__15079 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return url_encode__delegate.call(this,s,p__15079);};
url_encode.cljs$lang$maxFixedArity = 1;
url_encode.cljs$lang$applyTo = (function (arglist__15082){
var s = cljs.core.first(arglist__15082);
var p__15079 = cljs.core.rest(arglist__15082);
return url_encode__delegate(s,p__15079);
});
...
var url_decode__delegate = function (s,p__15083){var vec__15085 = p__15083;var encoding = cljs.core.nth.call(null,vec__15085,(0),null);if(cljs.core.truth_(s))
...
return url_decode__delegate.call(this,s,p__15083);};
url_decode.cljs$lang$maxFixedArity = 1;
url_decode.cljs$lang$applyTo = (function (arglist__15086){
var s = cljs.core.first(arglist__15086);
var p__15083 = cljs.core.rest(arglist__15086);
return url_decode__delegate(s,p__15083);
});
...
{var G__15089 = clojure.string.upper_case.call(null,unit);switch (G__15089) {
default:
var G__15090 = unit;switch (G__15090) {
case "M":
...
*/
no.en.core.parse_integer = (function parse_integer(s){return no.en.core.parse_number.call(null,s,(function (p1__15093_SHARP_){return parseInt(p1__15093_SHARP_);
}));
});
/**
* Parse `s` as a long number.
*/
no.en.core.parse_long = (function parse_long(s){return no.en.core.parse_number.call(null,s,(function (p1__15094_SHARP_){return parseInt(p1__15094_SHARP_);
}));
});
/**
* Parse `s` as a double number.
*/
no.en.core.parse_double = (function parse_double(s){return no.en.core.parse_number.call(null,s,(function (p1__15095_SHARP_){return parseFloat(p1__15095_SHARP_);
}));
});
/**
* Parse `s` as a float number.
*/
no.en.core.parse_float = (function parse_float(s){return no.en.core.parse_number.call(null,s,(function (p1__15096_SHARP_){return parseFloat(p1__15096_SHARP_);
}));
});
/**
* Format the map `m` into a query parameter string.
*/
no.en.core.format_query_params = (function format_query_params(m){var params = clojure.string.join.call(null,"&",cljs.core.map.call(null,(function (p1__15099_SHARP_){return clojure.string.join.call(null,"=",p1__15099_SHARP_);
}),cljs.core.map.call(null,(function (p1__15098_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[no.en.core.url_encode.call(null,cljs.core.name.call(null,cljs.core.first.call(null,p1__15098_SHARP_))),no.en.core.url_encode.call(null,cljs.core.second.call(null,p1__15098_SHARP_))],null));
}),cljs.core.remove.call(null,(function (p1__15097_SHARP_){return clojure.string.blank_QMARK_.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second.call(null,p1__15097_SHARP_))));
...
{return cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.mapcat.call(null,(function (p1__15104_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.keyword.call(null,no.en.core.url_decode.call(null,cljs.core.first.call(null,p1__15104_SHARP_))),no.en.core.url_decode.call(null,cljs.core.second.call(null,p1__15104_SHARP_))],null));
}),cljs.core.filter.call(null,(function (p1__15103_SHARP_){return cljs.core._EQ_.call(null,(2),cljs.core.count.call(null,p1__15103_SHARP_));
}),cljs.core.map.call(null,(function (p1__15102_SHARP_){return clojure.string.split.call(null,p1__15102_SHARP_,/=/);
...
}catch (e15106){if((e15106 instanceof Error))
{var e = e15106;if((n__$1 === (0)))
{throw e;
} else
{return null;
}
