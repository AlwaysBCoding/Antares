...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_146534 = (0);while(true){
var m_146535 = cljs.core.async.impl.dispatch.tasks.pop();if((m_146535 == null))
{} else
{m_146535.call(null);
if((count_146534 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__146536 = (count_146534 + (1));
count_146534 = G__146536;
continue;
}
} else
{}
