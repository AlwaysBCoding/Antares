...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15329 = (0);while(true){
var m_15330 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15330 == null))
{} else
{m_15330.call(null);
if((count_15329 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15331 = (count_15329 + (1));
count_15329 = G__15331;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3551__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3551__auto__)
