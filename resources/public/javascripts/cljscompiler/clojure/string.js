...
{{
var G__147389 = cljs.core.pop.call(null,v__$1);
v__$1 = G__147389;
continue;
}
} else
...
{var pred__147393 = cljs.core._EQ_;var expr__147394 = limit;if(cljs.core.truth_(pred__147393.call(null,(1),expr__147394)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__147393.call(null,(2),expr__147394)))
...
var G__147396 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__147397 = (limit__$1 - (1));
var G__147398 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__147396;
limit__$1 = G__147397;
parts = G__147398;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___147400 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___147400))
{var replacement_147401 = temp__4124__auto___147400;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_147401)));
} else
{buffer.append(ch);
}
{
var G__147402 = (index + (1));
index = G__147402;
continue;
}
}
