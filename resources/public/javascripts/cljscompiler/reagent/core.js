...
var G__12369__delegate = function (x,rest){return cljs.core.apply.call(null,reagent.ratom.atom,x,rest);
};
var G__12369 = function (x,var_args){
var rest = null;if (arguments.length > 1) {
  rest = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__12369__delegate.call(this,x,rest);};
G__12369.cljs$lang$maxFixedArity = 1;
G__12369.cljs$lang$applyTo = (function (arglist__12370){
var x = cljs.core.first(arglist__12370);
var rest = cljs.core.rest(arglist__12370);
return G__12369__delegate(x,rest);
});
...
partial.cljs$lang$applyTo = (function (arglist__12371){
