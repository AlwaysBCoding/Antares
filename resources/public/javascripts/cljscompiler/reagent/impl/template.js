...
{return (function() { 
var G__12391__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__12394 = res;(G__12394[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__12394;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__12395){var vec__12397 = p__12395;var id = cljs.core.nth.call(null,vec__12397,(0),null);var class$ = cljs.core.nth.call(null,vec__12397,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_12398 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_12398 === "key")))
{(o[pname_12398] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__12401 = jsprops;(G__12401["defaultValue"] = value);
(G__12401["value"] = null);
(G__12401["onChange"] = ((function (G__12401,on_change,value){
return (function (p1__12399_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__12399_SHARP_);
});})(G__12401,on_change,value))
);
return G__12401;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__12403 = spec;(G__12403["componentDidUpdate"] = ((function (G__12403){
return (function (){var C = this;return reagent.impl.template.input_did_update.call(null,C);
});})(G__12403))
);
(G__12403["componentWillUnmount"] = ((function (G__12403){
...
return (function (p1__12404_SHARP_,p2__12405_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__12404_SHARP_,p2__12405_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__12407 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__12407,(0),null);var id = cljs.core.nth.call(null,vec__12407,(1),null);var class$ = cljs.core.nth.call(null,vec__12407,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__12409 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__12409,(0),null);var id_class = cljs.core.nth.call(null,vec__12409,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj12413 = {};(obj12413[reagent.impl.util.cljs_argv] = v);
(obj12413[reagent.impl.util.cljs_level] = level);
return obj12413;
})();var k_12414 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__12415 = (((k_12414 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_12414);if((k_SINGLEQUOTE__12415 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__12415);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4409__auto___12416 = a.length;var i_12417 = (0);while(true){
if((i_12417 < n__4409__auto___12416))
{(a[i_12417] = reagent.impl.template.as_component.call(null,(a[i_12417]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4409__auto___12419 = a.length;var i_12420 = (0);while(true){
if((i_12420 < n__4409__auto___12419))
{if((i_12420 >= first_child))
{(a[i_12420] = reagent.impl.template.as_component.call(null,(a[i_12420]),level));
} else
{}
{
