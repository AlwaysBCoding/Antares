...
{var C_12388 = (a[i]);if(cljs.core.truth_(C_12388.cljsIsDirty))
{C_12388.forceUpdate();
} else
{}
{
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_12390 = C.cljsRatom;if(!((ratom_12390 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_12390);
} else
{}
