...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj7772 = {};return obj7772;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__3551__auto__ = this$;if(and__3551__auto__)
...
{var x__4190__auto__ = (((this$ == null))?null:this$);return (function (){var or__3563__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__4190__auto__)]);if(or__3563__auto__)
{return or__3563__auto__;
} else
{var or__3563__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__3563__auto____$1)
...
return (function (p__7773){var vec__7774 = p__7773;var k = cljs.core.nth.call(null,vec__7774,(0),null);var v = cljs.core.nth.call(null,vec__7774,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
