...
*/
cljs_http.util.build_url = (function build_url(p__15070){var map__15073 = p__15070;var map__15073__$1 = ((cljs.core.seq_QMARK_.call(null,map__15073))?cljs.core.apply.call(null,cljs.core.hash_map,map__15073):map__15073);var query_string = cljs.core.get.call(null,map__15073__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));var uri = cljs.core.get.call(null,map__15073__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));var server_port = cljs.core.get.call(null,map__15073__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));var server_name = cljs.core.get.call(null,map__15073__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));var scheme = cljs.core.get.call(null,map__15073__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__15074 = (new goog.Uri());G__15074.setScheme(cljs.core.name.call(null,(function (){var or__3553__auto__ = scheme;if(cljs.core.truth_(or__3553__auto__))
{return or__3553__auto__;
} else
{return new cljs.core.Keyword(null,"http","http",382524695);
}
})()));
G__15074.setDomain(server_name);
G__15074.setPort(server_port);
G__15074.setPath(uri);
G__15074.setQuery(query_string,true);
return G__15074;
})()));
});
/**
...
cljs_http.util.parse_headers = (function parse_headers(headers){return cljs.core.reduce.call(null,(function (p1__15076_SHARP_,p2__15075_SHARP_){var vec__15078 = clojure.string.split.call(null,p2__15075_SHARP_,/:\s+/);var k = cljs.core.nth.call(null,vec__15078,(0),null);var v = cljs.core.nth.call(null,vec__15078,(1),null);if(cljs.core.truth_((function (){var or__3553__auto__ = clojure.string.blank_QMARK_.call(null,k);if(cljs.core.truth_(or__3553__auto__))
{return or__3553__auto__;
} else
{return clojure.string.blank_QMARK_.call(null,v);
}
})()))
{return p1__15076_SHARP_;
} else
{return cljs.core.assoc.call(null,p1__15076_SHARP_,clojure.string.lower_case.call(null,k),v);
}
