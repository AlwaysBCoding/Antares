...
format.cljs$lang$applyTo = (function (arglist__14826){
var fmt = cljs.core.first(arglist__14826);
...
;
garden.util.ToString = (function (){var obj14828 = {};return obj14828;
})();
garden.util.to_str = (function to_str(this$){if((function (){var and__3541__auto__ = this$;if(and__3541__auto__)
...
{var x__4180__auto__ = (((this$ == null))?null:this$);return (function (){var or__3553__auto__ = (garden.util.to_str[goog.typeOf(x__4180__auto__)]);if(or__3553__auto__)
{return or__3553__auto__;
} else
{var or__3553__auto____$1 = (garden.util.to_str["_"]);if(or__3553__auto____$1)
...
as_str.cljs$lang$applyTo = (function (arglist__14829){
...
var string__GT_int__delegate = function (s,p__14830){var vec__14832 = p__14830;var radix = cljs.core.nth.call(null,vec__14832,(0),null);var radix__$1 = (function (){var or__3553__auto__ = radix;if(cljs.core.truth_(or__3553__auto__))
{return or__3553__auto__;
} else
{return (10);
}
...
var p__14830 = null;if (arguments.length > 1) {
  p__14830 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return string__GT_int__delegate.call(this,s,p__14830);};
string__GT_int.cljs$lang$maxFixedArity = 1;
string__GT_int.cljs$lang$applyTo = (function (arglist__14833){
var s = cljs.core.first(arglist__14833);
var p__14830 = cljs.core.rest(arglist__14833);
return string__GT_int__delegate(s,p__14830);
});
...
var int__GT_string__delegate = function (i,p__14834){var vec__14836 = p__14834;var radix = cljs.core.nth.call(null,vec__14836,(0),null);var radix__$1 = (function (){var or__3553__auto__ = radix;if(cljs.core.truth_(or__3553__auto__))
{return or__3553__auto__;
} else
{return (10);
}
...
var p__14834 = null;if (arguments.length > 1) {
  p__14834 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return int__GT_string__delegate.call(this,i,p__14834);};
int__GT_string.cljs$lang$maxFixedArity = 1;
int__GT_string.cljs$lang$applyTo = (function (arglist__14837){
var i = cljs.core.first(arglist__14837);
var p__14834 = cljs.core.rest(arglist__14837);
return int__GT_string__delegate(i,p__14834);
});
...
* spaces.
*/
garden.util.comma_join = (function comma_join(xs){var ys = (function (){var iter__4278__auto__ = (function iter__14842(s__14843){return (new cljs.core.LazySeq(null,(function (){var s__14843__$1 = s__14843;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__14843__$1);if(temp__4126__auto__)
{var s__14843__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__14843__$2))
{var c__4276__auto__ = cljs.core.chunk_first.call(null,s__14843__$2);var size__4277__auto__ = cljs.core.count.call(null,c__4276__auto__);var b__14845 = cljs.core.chunk_buffer.call(null,size__4277__auto__);if((function (){var i__14844 = (0);while(true){
if((i__14844 < size__4277__auto__))
{var x = cljs.core._nth.call(null,c__4276__auto__,i__14844);cljs.core.chunk_append.call(null,b__14845,((cljs.core.sequential_QMARK_.call(null,x))?garden.util.space_join.call(null,x):garden.util.to_str.call(null,x)));
{
var G__14846 = (i__14844 + (1));
i__14844 = G__14846;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__14845),iter__14842.call(null,cljs.core.chunk_rest.call(null,s__14843__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__14845),null);
}
} else
{var x = cljs.core.first.call(null,s__14843__$2);return cljs.core.cons.call(null,((cljs.core.sequential_QMARK_.call(null,x))?garden.util.space_join.call(null,x):garden.util.to_str.call(null,x)),iter__14842.call(null,cljs.core.rest.call(null,s__14843__$2)));
}
} else
{return null;
}
...
*/
garden.util.record_QMARK_ = (function record_QMARK_(x){var G__14848 = x;if(G__14848)
{var bit__4203__auto__ = (G__14848.cljs$lang$protocol_mask$partition0$ & (67108864));if((bit__4203__auto__) || (G__14848.cljs$core$IRecord$))
{return true;
} else
{if((!G__14848.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IRecord,G__14848);
} else
{return false;
}
}
...
*/
garden.util.between_QMARK_ = (function between_QMARK_(n,a,b){var bottom = (function (){var x__3867__auto__ = a;var y__3868__auto__ = b;return ((x__3867__auto__ < y__3868__auto__) ? x__3867__auto__ : y__3868__auto__);
})();var top = (function (){var x__3860__auto__ = a;var y__3861__auto__ = b;return ((x__3860__auto__ > y__3861__auto__) ? x__3860__auto__ : y__3861__auto__);
})();return ((n >= bottom)) && ((n <= top));
});
/**
* Return a number such that n is no less than a and no more than b.
*/
garden.util.clip = (function clip(a,b,n){var vec__14850 = (((a <= b))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,b], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [b,a], null));var a__$1 = cljs.core.nth.call(null,vec__14850,(0),null);var b__$1 = cljs.core.nth.call(null,vec__14850,(1),null);var x__3860__auto__ = a__$1;var y__3861__auto__ = (function (){var x__3867__auto__ = b__$1;var y__3868__auto__ = n;return ((x__3867__auto__ < y__3868__auto__) ? x__3867__auto__ : y__3868__auto__);
...
average.cljs$lang$applyTo = (function (arglist__14851){
var n = cljs.core.first(arglist__14851);
arglist__14851 = cljs.core.next(arglist__14851);
var m = cljs.core.first(arglist__14851);
var more = cljs.core.rest(arglist__14851);
...
{{
var G__14852 = (i - (1));
var G__14853 = cljs.core.assoc.call(null,v_seqs__$2,i,v_original_seqs.call(null,i));
i = G__14852;
v_seqs__$2 = G__14853;
continue;
}
...
cartesian_product.cljs$lang$applyTo = (function (arglist__14854){
var seqs = cljs.core.seq(arglist__14854);
