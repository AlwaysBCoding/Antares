...
format.cljs$lang$applyTo = (function (arglist__11081){
var fmt = cljs.core.first(arglist__11081);
...
;
garden.util.ToString = (function (){var obj11083 = {};return obj11083;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__11084){
...
var string__GT_int__delegate = function (s,p__11085){var vec__11087 = p__11085;var radix = cljs.core.nth.call(null,vec__11087,(0),null);var radix__$1 = (function (){var or__3543__auto__ = radix;if(cljs.core.truth_(or__3543__auto__))
{return or__3543__auto__;
} else
{return (10);
}
...
var p__11085 = null;if (arguments.length > 1) {
  p__11085 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return string__GT_int__delegate.call(this,s,p__11085);};
string__GT_int.cljs$lang$maxFixedArity = 1;
string__GT_int.cljs$lang$applyTo = (function (arglist__11088){
var s = cljs.core.first(arglist__11088);
var p__11085 = cljs.core.rest(arglist__11088);
return string__GT_int__delegate(s,p__11085);
});
...
var int__GT_string__delegate = function (i,p__11089){var vec__11091 = p__11089;var radix = cljs.core.nth.call(null,vec__11091,(0),null);var radix__$1 = (function (){var or__3543__auto__ = radix;if(cljs.core.truth_(or__3543__auto__))
{return or__3543__auto__;
} else
{return (10);
}
...
var p__11089 = null;if (arguments.length > 1) {
  p__11089 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return int__GT_string__delegate.call(this,i,p__11089);};
int__GT_string.cljs$lang$maxFixedArity = 1;
int__GT_string.cljs$lang$applyTo = (function (arglist__11092){
var i = cljs.core.first(arglist__11092);
var p__11089 = cljs.core.rest(arglist__11092);
return int__GT_string__delegate(i,p__11089);
});
...
* spaces.
*/
garden.util.comma_join = (function comma_join(xs){var ys = (function (){var iter__4268__auto__ = (function iter__11097(s__11098){return (new cljs.core.LazySeq(null,(function (){var s__11098__$1 = s__11098;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__11098__$1);if(temp__4126__auto__)
{var s__11098__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__11098__$2))
{var c__4266__auto__ = cljs.core.chunk_first.call(null,s__11098__$2);var size__4267__auto__ = cljs.core.count.call(null,c__4266__auto__);var b__11100 = cljs.core.chunk_buffer.call(null,size__4267__auto__);if((function (){var i__11099 = (0);while(true){
if((i__11099 < size__4267__auto__))
{var x = cljs.core._nth.call(null,c__4266__auto__,i__11099);cljs.core.chunk_append.call(null,b__11100,((cljs.core.sequential_QMARK_.call(null,x))?garden.util.space_join.call(null,x):garden.util.to_str.call(null,x)));
{
var G__11101 = (i__11099 + (1));
i__11099 = G__11101;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__11100),iter__11097.call(null,cljs.core.chunk_rest.call(null,s__11098__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__11100),null);
}
} else
{var x = cljs.core.first.call(null,s__11098__$2);return cljs.core.cons.call(null,((cljs.core.sequential_QMARK_.call(null,x))?garden.util.space_join.call(null,x):garden.util.to_str.call(null,x)),iter__11097.call(null,cljs.core.rest.call(null,s__11098__$2)));
}
} else
{return null;
}
...
*/
garden.util.record_QMARK_ = (function record_QMARK_(x){var G__11103 = x;if(G__11103)
{var bit__4193__auto__ = (G__11103.cljs$lang$protocol_mask$partition0$ & (67108864));if((bit__4193__auto__) || (G__11103.cljs$core$IRecord$))
{return true;
} else
{if((!G__11103.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IRecord,G__11103);
} else
{return false;
}
}
...
*/
garden.util.clip = (function clip(a,b,n){var vec__11105 = (((a <= b))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,b], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [b,a], null));var a__$1 = cljs.core.nth.call(null,vec__11105,(0),null);var b__$1 = cljs.core.nth.call(null,vec__11105,(1),null);var x__3850__auto__ = a__$1;var y__3851__auto__ = (function (){var x__3857__auto__ = b__$1;var y__3858__auto__ = n;return ((x__3857__auto__ < y__3858__auto__) ? x__3857__auto__ : y__3858__auto__);
...
average.cljs$lang$applyTo = (function (arglist__11106){
var n = cljs.core.first(arglist__11106);
...
{{
var G__11107 = (i - (1));
var G__11108 = cljs.core.assoc.call(null,v_seqs__$2,i,v_original_seqs.call(null,i));
i = G__11107;
v_seqs__$2 = G__11108;
continue;
}
...
cartesian_product.cljs$lang$applyTo = (function (arglist__11109){
var seqs = cljs.core.seq(arglist__11109);
